...
Features
Download Satellite Images: Downloads Landsat images using an API (e.g., USGS Earth Explorer or AWS Landsat).
Preprocessing:
...
U-Net CNN for UHI Detection: Implements a U-Net model to detect UHI areas using satellite data.
Post-processing:
