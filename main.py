...
try:
    from .config import (
        EARTHEXPLORER_USERNAME, EARTHEXPLORER_PASSWORD, M2M_API_URL,
        API_TOKEN_EXPIRATION_DAYS, API_CATALOG_ID, M2M_API_TOKEN,
        SEARCH_ENDPOINT, METADATA_ENDPOINT, DOWNLOAD_ENDPOINT,
        DOWNLOAD_OPTIONS_ENDPOINT, DOWNLOAD_REQUEST_ENDPOINT,
        LOGIN_TOKEN_ENDPOINT, CONNECT_TIMEOUT, READ_TIMEOUT,
        VERIFY_SSL, MAX_RETRIES, RETRY_BACKOFF
    )
